...
static inline std::uint64_t get_piece(const Board& b, const Piece p)
{
...
static inline std::uint64_t get_colour(const Board& b, const Colour c)
{
...
static inline std::uint64_t get_piece(const Board& b, const Piece p, const Colour c)
{
        assert(piece_is_ok(p));
        assert(colour_is_ok(c));
...
static inline void set_bit(Board& b, const Piece p, const int sq)
{
        assert(piece_is_ok(p));
...
static inline void set_bit(Board& b, const Colour c, const int sq)
{
        assert(colour_is_ok(c));
        assert(square_is_ok(sq));
...
static inline void clear_bit(Board& b, const Piece p, const int sq)
{
        assert(piece_is_ok(p));
        assert(square_is_ok(sq));
...
static inline void clear_bit(Board& b, const Colour c, const int sq)
{
        assert(colour_is_ok(c));
